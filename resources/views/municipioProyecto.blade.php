  ...
  <section class="container-fluid">
    <div class="row">
            <div class=" text-center col-md-3 p-0">
                <button class="btn btn-md btn-primary text-white text-center mb-2 mt-2 ml-2" data-toggle="collapse" href="#tipoProyecto" role="button" aria-expanded="false" aria-controls="tipoProyecto">PROYECTOS DEL MUNICIPIO <br> SABANALARGA</button>
            ...
            <div class="col-md-9 p-0">
                ...
                <div class="mapContainer" style="height: 82vh; width:100%">
                    <div id="map_p" style="height:100%"></div>
                </div>
            </div>
        </div>
    </div>
